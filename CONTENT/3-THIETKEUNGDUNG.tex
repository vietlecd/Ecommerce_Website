...
\begin{itemize}
    ...
    \item \textbf{Quản lý khuyến mãi}: Thiết lập và theo dõi các chương trình khuyến mãi.
\end{itemize}
...
\subsubsection{Trang Khuyến Mãi:}
\begin{itemize}
    \item \textbf{Danh sách bài viết}: Hiển thị các bài khuyến mãi dưới dạng danh sách hoặc lưới.
    \item \textbf{Hình ảnh đại diện}: Mỗi khuyến mãi có hình ảnh thumbnail minh họa.
    \item \textbf{Thông tin cơ bản}: Hiển thị tiêu đề, mô tả ngắn, và ngày đăng của khuyến mãi.
\end{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{IMG/showimages/ERD.jpg} 
