<div id="chat-widget" class="chat-widget" aria-live="polite">
    <button type="button" id="chat-button" class="chat-fab" aria-expanded="false" aria-controls="chat-window">
        <span class="chat-fab-icon">
            <i class="fas fa-comments"></i>
        </span>
        <div class="chat-fab-text">
            <span class="chat-fab-label">Need guidance?</span>
            <span class="chat-fab-subtitle">Talk to our concierge</span>
        </div>
    </button>
    <div id="chat-window" class="chat-window" role="dialog" aria-modal="false" aria-hidden="true">
        <div class="chat-header">
            <div class="chat-header-text">
                <strong>Product Consultation</strong>
                <span>Replies within seconds</span>
            </div>
            <div class="chat-status">
                <span class="chat-status-dot"></span>
                <span>Online</span>
            </div>
            <button type="button" id="chat-close" class="chat-close" aria-label="Close chat">
                <i class="fas fa-xmark"></i>
            </button>
        </div>
        <div class="chat-body">
            <div id="chat-messages" class="chat-messages" aria-live="polite"></div>
            <form class="chat-input-group" autocomplete="off">
                <input type="text" id="chat-input" class="chat-input" placeholder="Ask about fit, drops, promos..." aria-label="Chat message">
...
(function() {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', bootstrapChatWidget);
    } else {
        bootstrapChatWidget();
    }
})();
